  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed bottom-5 end-5 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-lg shadow-emerald-500/30"
      >
